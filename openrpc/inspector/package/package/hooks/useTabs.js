...
var useTabs = function (defaultTabs) {
    var _a = react_1.useState(0), tabIndex = _a[0], setTabIndex = _a[1];
    var _b = react_1.useState(defaultTabs || [{ name: "New Tab", content: emptyJSONRPC, url: undefined, logs: [] }]), tabs = _b[0], setTabs = _b[1];
