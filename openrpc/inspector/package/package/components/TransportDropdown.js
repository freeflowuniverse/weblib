...
var TransportDropdown = function (_a) {
    ...
    var _d = react_1.useState(), selectedCustomTransport = _d[0], setSelectedCustomTransport = _d[1];
    var _e = react_1.useState(), customTransportName = _e[0], setCustomTransportName = _e[1];
    var _f = react_1.useState(), customTransportUri = _f[0], setCustomTransportUri = _f[1];
    var _g = react_1.useState(null), dialogMenuAnchorEl = _g[0], setDialogMenuAnchorEl = _g[1];
    ...
    return (react_1.default.createElement("div", { style: style },
        react_1.default.createElement(core_1.Dialog, { onClose: function () { return setDialogOpen(false); }, "aria-labelledby": "simple-dialog-title", open: dialogOpen },
            react_1.default.createElement(core_1.Container, { maxWidth: "sm" },
                react_1.default.createElement(core_1.Grid, { container: true, justify: "space-between", alignItems: "center", style: { padding: "30px", paddingTop: "10px", paddingBottom: "10px", marginTop: "10px" } },
                    ...
                    react_1.default.createElement(core_1.Grid, { container: true, direction: "column", spacing: 1 },
                        ...
                        react_1.default.createElement(core_1.Grid, { item: true },
                            react_1.default.createElement(core_1.Button, { variant: "outlined", onClick: handleDialogCustomTransportClick }, selectedCustomTransport ? selectedCustomTransport.name : "Select A Transport"))),
                    react_1.default.createElement(core_1.Menu, { id: "transport-menu", anchorEl: dialogMenuAnchorEl, keepMounted: true, open: Boolean(dialogMenuAnchorEl), onClose: handleDialogAnchorClose }, transports.filter(function (value) { return value.type !== "plugin"; }).map(function (transport, i) { return (react_1.default.createElement(core_1.MenuItem, { onClick: function () { return handleCustomTransportDialogMenuItemClick(transport); } }, transport.name)); })),
                    react_1.default.createElement(core_1.Button, { style: { marginTop: "10px", marginBottom: "10px" }, onClick: handleSubmitCustomTransport, disabled: !customTransportName || !customTransportUri || !selectedCustomTransport, variant: "contained" }, "Add Transport")))),
        ...
        react_1.default.createElement(core_1.Menu, { id: "transport-menu", anchorEl: anchorEl, keepMounted: true, open: Boolean(anchorEl), onClose: handleClose },
            transports.map(function (transport, i) { return (react_1.default.createElement(core_1.MenuItem, { onClick: function () { return handleMenuItemClick(transport); } }, transport.name)); }),
