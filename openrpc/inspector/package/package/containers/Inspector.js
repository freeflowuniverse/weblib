...
var useCustomTransportList = use_persisted_state_1.default("inspector-custom-transports");
...
var defaultSettings = { 'timeout': 10000 };
var Inspector = function (props) {
    var _a = useTabs_1.default([
        {
    ...
    var _b = react_1.useState(props.openrpcDocument), openrpcDocument = _b[0], setOpenRpcDocument = _b[1];
    var _c = react_1.useState(props.request || {
        jsonrpc: "2.0",
        method: "",
        params: [],
        id: 0,
    ...
    var _d = useCustomTransportList(function () {
        if (props.customTransport) {
            return __spreadArrays(defaultTransports, [props.customTransport]);
        }
        return defaultTransports;
    }), transportList = _d[0], setTransportList = _d[1];
    var _e = react_1.useState(props.url || ""), url = _e[0], setUrl = _e[1];
    var debouncedUrl = use_debounce_1.useDebounce(url, 1000)[0];
    var _f = react_1.useState(props.customTransport || defaultTransports[0]), selectedTransport = _f[0], setSelectedTransport = _f[1];
    var _g = react_1.useState(), transportOptions = _g[0], setTransportOptions = _g[1];
    var debouncedtransportOptions = use_debounce_1.useDebounce(transportOptions, 1000)[0];
    var _h = useTransport_1.default(transportList, debouncedUrl, props.customTransport || defaultTransports[0], debouncedtransportOptions), transport = _h[0], setTransport = _h[1], connected = _h[3];
    var _j = react_1.useState(false), settingsOpen = _j[0], setSettingsOpen = _j[1];
    var _k = react_1.useState(defaultSettings), settings = _k[0], setSettings = _k[1];
    var _l = react_1.useState(false), historyOpen = _l[0], setHistoryOpen = _l[1];
    var _m = react_1.useState([]), requestHistory = _m[0], setRequestHistory = _m[1];
    var _o = react_1.useState(0), historySelectedIndex = _o[0], setHistorySelectedIndex = _o[1];
    var _p = react_1.useState([]), logs = _p[0], setLogs = _p[1];
    react_1.useEffect(function () {
        setTabs(__spreadArrays(tabs, [
            {
    ...
    react_1.useEffect(function () {
        if (props.transport) {
            var t = transportList
                .find(function (tp) { var _a, _b; return ((_a = tp.name) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === ((_b = props.transport) === null || _b === void 0 ? void 0 : _b.toLowerCase()); });
            if (t) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    newHistory = __spreadArrays(requestHistory, [__assign({}, tabs[tabIndex])]);
                    setRequestHistory(newHistory);
                    setLogs(function (prevLogs) { return __spreadArrays(prevLogs, [reqObj_1, resObj_1]); });
                    setTabLogs(tabIndex, __spreadArrays((tabs[tabIndex].logs || []), [reqObj_1, resObj_1]));
                    return [3 /*break*/, 4];
                case 3:
                    e_1 = _a.sent();
                    responseTimestamp = new Date();
                    ...
                    newHistory = __spreadArrays(requestHistory, [__assign({}, tabs[tabIndex])]);
                    setRequestHistory(newHistory);
                    setLogs(function (prevLogs) { return __spreadArrays(prevLogs, [reqObj_2, resObj_2]); });
                    setTabLogs(tabIndex, __spreadArrays((tabs[tabIndex].logs || []), [reqObj_2, resObj_2]));
                    return [3 /*break*/, 4];
    ...
    var refreshOpenRpcDocument = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, ((_a = transport) === null || _a === void 0 ? void 0 : _a.sendData({
                            internalID: 999999,
                            request: {
                                jsonrpc: "2.0",
                                params: [],
                ...
                case 4:
                    if (transport) {
                        transport.subscribe("notification", function (notification) {
                            ...
                            setLogs(function (prevLogs) { return __spreadArrays(prevLogs, [notificationObj]); });
                            setTabLogs(tabIndex, __spreadArrays((tabs[tabIndex].logs || []), [notificationObj]));
                        });
    ...
    var handleSettingsChange = function (event) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(core_1.Dialog, { onClose: function () { return setHistoryOpen(false); }, "aria-labelledby": "simple-dialog-title", open: historyOpen },
            react_1.default.createElement(core_1.Container, { maxWidth: "sm" },
                react_1.default.createElement(core_1.Grid, { container: true, justify: "space-between", alignItems: "center", style: { padding: "30px", paddingTop: "10px", paddingBottom: "10px" } },
                    react_1.default.createElement(core_1.Typography, { color: "textPrimary" }, "History"),
                    requestHistory.length === 0
                        ? null
                        : react_1.default.createElement(core_1.Tooltip, { title: "Use" },
                ...
                requestHistory.length === 0
                    ? react_1.default.createElement(core_1.Typography, { style: { padding: "30px" } }, "No History Yet.")
                    : react_1.default.createElement(core_1.Grid, { container: true, style: { paddingBottom: "30px" } },
                        react_1.default.createElement(core_1.List, { style: { padding: "10px", overflowY: "scroll", height: "250px", width: "200px" } }, requestHistory.map(function (requestHistoryItem, historyIndex) { return (react_1.default.createElement(core_1.ListItem, { button: true, onClick: function () { return setHistorySelectedIndex(historyIndex); }, selected: historyIndex === historySelectedIndex },
                        ...
                        react_1.default.createElement(react_monaco_editor_1.default, { width: "300px", height: "250px", value: requestHistory[historySelectedIndex]
                                ? JSON.stringify(requestHistory[historySelectedIndex].content, null, 4)
                                : "", language: "json", editorDidMount: function () {
                                // noop
                            } })))),
        react_1.default.createElement(core_1.Dialog, { onClose: function () { return setSettingsOpen(false); }, "aria-labelledby": "simple-dialog-title", open: settingsOpen },
            react_1.default.createElement(core_1.DialogTitle, null, "Settings"),
            react_1.default.createElement(core_1.DialogContent, null,
                react_1.default.createElement(core_1.DialogContentText, null, "Settings for inspector requests."),
                react_1.default.createElement(core_1.TextField, { autoFocus: true, inputProps: { step: "500" }, margin: "dense", id: "timeout", label: "Request Timeout", type: "number", value: settings.timeout, fullWidth: true, variant: "standard", onChange: handleSettingsChange })),
            react_1.default.createElement(core_1.DialogActions, null,
                react_1.default.createElement(core_1.Button, { onClick: function () { setSettingsOpen(false); setSettings(defaultSettings); } }, "Default"),
                react_1.default.createElement(core_1.Button, { onClick: function () { return setSettingsOpen(false); } }, "Save"))),
        react_1.default.createElement("div", { style: { position: "relative" } },
            react_1.default.createElement(core_1.Tabs, { style: { background: "transparent" }, value: tabIndex, variant: "scrollable", indicatorColor: "primary", onChange: handleTabIndexChange },
                tabs.map(function (tab, index) { return (react_1.default.createElement(core_1.Tab, { disableRipple: true, style: {
                        border: "none",
                        outline: "none",
                        userSelect: "none",
                    }, onDoubleClick: function () { return setTabEditing(tab, true); }, label: react_1.default.createElement("div", { style: { userSelect: "none" } },
                        tab.editing
                            ? react_1.default.createElement(core_1.InputBase, { value: tab.name, onChange: function (ev) { return handleLabelChange(ev, tab); }, onBlur: function () { return setTabEditing(tab, false); }, autoFocus: true, style: { maxWidth: "80px", marginRight: "25px" } })
                            : react_1.default.createElement(core_1.Typography, { style: { display: "inline", textTransform: "none", marginRight: "25px" }, variant: "body1" }, tab.name),
                        tabIndex === index
                            ?
                                react_1.default.createElement(core_1.Tooltip, { title: "Close Tab" },
                                    react_1.default.createElement(core_1.IconButton, { onClick: function (ev) { return handleClose(ev, index); }, style: { position: "absolute", right: "10px", top: "25%" }, size: "small" },
                ...
                react_1.default.createElement(core_1.Tab, { disableRipple: true, style: { minWidth: "50px" }, label: react_1.default.createElement(core_1.Tooltip, { title: "Create New Tab" },
                        react_1.default.createElement(core_1.IconButton, { onClick: function () { return setTabs(__spreadArrays(tabs, [
                                {
                                    name: "New Tab",
        ...
        react_1.default.createElement(core_1.AppBar, { elevation: 0, position: "static", style: { zIndex: 1 } },
            react_1.default.createElement(core_1.Toolbar, null,
                ...
                react_1.default.createElement(TransportDropdown_1.default, { transports: transportList, onAddTransport: function (addedTransport) {
                        setTransportList(__spreadArrays(transportList, [
                            addedTransport,
                        ]));
                    }, selectedTransport: selectedTransport, onChange: function (changedTransport) { return setSelectedTransport(changedTransport); }, style: {
                        marginLeft: "10px",
                    } }),
                ...
                react_1.default.createElement(core_1.InputBase, { startAdornment: react_1.default.createElement(react_1.default.Fragment, null,
                        react_1.default.createElement(core_1.Tooltip, { title: connected ? "Connected" : "Not Connected" }, connected
                            ? react_1.default.createElement(FlashOn_1.default, { style: { color: colors_1.green[500] } })
                            : react_1.default.createElement(FlashOff_1.default, { color: "error" })),
                        openrpcDocument
                            ?
                                react_1.default.createElement(core_1.Tooltip, { title: react_1.default.createElement("div", { style: { textAlign: "center" } },
                                        react_1.default.createElement(core_1.Typography, null, "OpenRPC Document Detected"),
                                        react_1.default.createElement(core_1.Typography, { variant: "caption" }, "A JSON-RPC endpoint may respond to the rpc.discover method or a provide a static document. This adds features like auto completion to the inspector.")), onClick: function () { return window.open("https://spec.open-rpc.org/#service-discovery-method"); } },
                                    react_1.default.createElement(Description_1.default, { style: { color: colors_1.green[500], marginRight: "5px", cursor: "pointer" }, scale: 0.1 }))
                            : null), value: url, placeholder: "Enter a JSON-RPC server URL", onChange: function (event) {
                        setUrl(event.target.value);
                        setTabUrl(tabIndex, event.target.value);
                    }, fullWidth: true, style: { background: "rgba(0,0,0,0.1)", borderRadius: "4px", padding: "0px 10px", marginRight: "5px" } }),
                ...
                react_1.default.createElement(core_1.Tooltip, { title: "Settings" },
                    react_1.default.createElement(core_1.IconButton, { onClick: function () { return setSettingsOpen(true); } },
                        react_1.default.createElement(Settings_1.default, null))),
                props.hideToggleTheme
                    ? null
                    :
                        react_1.default.createElement(core_1.Tooltip, { title: "Toggle Theme" },
        ...
        react_1.default.createElement(react_split_pane_1.default, { split: "vertical", minSize: 100, maxSize: -100, defaultSize: "50%", pane2Style: { height: "100%", width: "100%", overflow: "auto" }, style: { flexGrow: 1, height: "calc(100% - 128px)" } },
            ...
            react_1.default.createElement(react_1.default.Fragment, null,
                logs.length > 0 &&
                    react_1.default.createElement(core_1.Button, { variant: "contained", style: {
                            cursor: "pointer",
                            position: "absolute",
                            top: "5px",
                            right: "50px",
