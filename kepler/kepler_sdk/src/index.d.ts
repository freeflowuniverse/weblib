export { KeplerOptions, OrbitConnection, Request, Response, Bytes, WalletProvider, HostConfig, Session, SessionConfig, activateSession, hostOrbit, } from "@spruceid/kepler-sdk-wrapper";
import { Kepler as Kepler_, WalletProvider, KeplerOptions, OrbitConnection, SessionConfig } from "@spruceid/kepler-sdk-wrapper";
export declare class Kepler extends Kepler_ {
    /**
