...
var OrbitConnection = /** @class */ (function () {
    ...
    function OrbitConnection(keplerUrl, authn) {
        ...
        this.caps = new capabilities_1.Capabilities(keplerUrl, authn);
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (value === null || value === undefined) {
                    return [2 /*return*/, Promise.reject("TypeError: value of type ".concat(typeof value, " cannot be stored."))];
                }
                ...
                return [2 /*return*/, this.kv.put(key, blob, (req === null || req === void 0 ? void 0 : req.headers) || {}).then(transformResponse)];
            });
        });
    };
    ...
    OrbitConnection.prototype.sessions = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.caps.get("all")];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    OrbitConnection.prototype.deleteAll = function (prefix) {
        if (prefix === void 0) { prefix = ""; }
        return __awaiter(this, void 0, void 0, function () {
            var kr, keys;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.kv.list(prefix)];
                    case 1:
                        kr = _a.sent();
                        if (!kr.ok)
                            return [2 /*return*/, [kr]];
                        return [4 /*yield*/, kr.json()];
                    case 2:
                        keys = _a.sent();
                        return [4 /*yield*/, Promise.all(keys.map(function (key) { return _this.delete(key); }))];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, fetch(keplerUrl + "/peer/generate/".concat(encodeURIComponent(orbitId))).then(function (res) { return res.text(); })];
                case 3:
                    peerId = _a.sent();
                    config = {
                        address: address,
                    ...
                    siwe = (0, module_1.generateHostSIWEMessage)(JSON.stringify(config));
                    return [4 /*yield*/, wallet.signMessage(siwe)];
                case 4:
                    signature = _a.sent();
                    hostHeaders = (0, module_1.siweToDelegationHeaders)(JSON.stringify({ siwe: siwe, signature: signature }));
