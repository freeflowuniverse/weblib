...
var Kepler = /** @class */ (function () {
    ...
    Kepler.prototype.orbit = function (config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var keplerUrl, sessionInfo;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        keplerUrl = this.config.hosts[0];
                        return [4 /*yield*/, (0, authenticator_1.startSession)(this.wallet, config)];
                    case 1:
                        sessionInfo = _a.sent();
                        return [4 /*yield*/, (0, authenticator_1.activateSession)(sessionInfo, keplerUrl)
                                .catch(function (_a) {
                                var status = _a.status, msg = _a.msg;
                                return __awaiter(_this, void 0, void 0, function () {
                                    var _b, hostStatus, statusText;
                                    return __generator(this, function (_c) {
                                        switch (_c.label) {
                                            case 0:
                                                if (!(status === 404)) return [3 /*break*/, 5];
                                                return [4 /*yield*/, (0, orbit_1.hostOrbit)(this.wallet, keplerUrl, sessionInfo.orbitId, config.domain)];
                                            case 1:
                                                _b = _c.sent(), hostStatus = _b.status, statusText = _b.statusText;
                                                if (!(hostStatus === 200)) return [3 /*break*/, 3];
                                                return [4 /*yield*/, (0, authenticator_1.activateSession)(sessionInfo, keplerUrl)];
                                            case 2: return [2 /*return*/, _c.sent()];
                                            case 3: throw new Error("Failed to open new Orbit: " + statusText);
                                            case 4: return [3 /*break*/, 6];
                                            case 5: throw new Error("Failed to delegate to session key: " + msg);
